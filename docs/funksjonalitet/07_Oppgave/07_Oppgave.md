...
* Hvis oppgaven skal løses av saksbehandler nasjonal eller beslutter kalles ikke Norg:
    ...
    * Hvis personen eller barn av personen har skjerming, settes enhet til NAY Egen ansatt (4483)
...
* Hvis oppgaven skal løses av lokal saksbehandler kalles Norg:
    ...
    * Hvis personen eller barn av personen har skjerming eller adressebeskyttelse, brukes enhet fra Norg (henholdsvis egen ansatt-enhet og Nav Vikafossen)
