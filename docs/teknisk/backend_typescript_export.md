...
- Her sendes artifact-id og app-name og with-enums med inn i den nye flowen som inputs. For å få lov til å gjøre dette brukes en github PAT fra en av teammedlemmenes(Marius). Her går det an å bruke en github app i stedet
