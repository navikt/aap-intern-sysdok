...
- Login på npm med `npm login --scope=@navikt --registry=https://npm.pkg.github.com` og benytt github brukernavn, epost og tokenet du nettopp genererte som passord når du logger inn.
...
| [ AAP søknader](https://github.com/navikt/aap-soknad)               | NEXT.JS, Typescript          | Frontend for søknad for AAP                                                                                                |
...
| [Mikrofrontend Min Side](https://github.com/navikt/aap-min-side-microfrontend) | Vite, Typescript  | Mikrfrontend for å vise status i sak på Min Side |
