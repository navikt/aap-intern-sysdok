...
Denne tegningen viser en oversikt over hvilke informasjonstyper vi har i datamodellen. <br/> 
Den viser:
- Hvilken informasjon som samles inn i søknaden
- Tas vare på i søknaden og brukes videre i Mine AAP og Min side. 
...
TODO:
- [ ] Oppdatere informasjonsmodell i mural, 
- Legge til tegnforklaring / farger, 
- Legge ved eksempler på de ulike informasjonstypene.
