...
DEFAULT_REPOS=(
  ...
  "navikt/aap-arena-hendelse-proxy"
  ...
  "navikt/aap-cli"
  "navikt/aap-dokumentinnhenting"
  "navikt/aap-felles-frontend"
  "navikt/aap-fss-proxy"
  "navikt/aap-innsending"
  "navikt/aap-intern-sysdok"
  "navikt/aap-kalkulator-frontend"
  "navikt/aap-kelvin-komponenter"
  "navikt/aap-kelvinMalinger"
  "navikt/aap-meldekort"
  "navikt/aap-meldekort-backend"
  "navikt/aap-min-side-microfrontend"
  "navikt/aap-oppgave"
  "navikt/aap-oppslag"
  "navikt/aap-paw-patrol"
  "navikt/aap-pdfgen"
  "navikt/aap-pdfgen-meldekort"
  "navikt/aap-postmottak-backend"
  "navikt/aap-saksbehandling"
  "navikt/aap-saksbehandling-pdfgen"
